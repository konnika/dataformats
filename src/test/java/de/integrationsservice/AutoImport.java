...
/**
 * Das AutoImport-Tag wird vom externen System verwendet (nur per Webservice),
 * um ein Kreditgeschäft in der MARZIPAN-Datenbank, im Status Erstellt, zu speichern.
 ...
 *
 * <p>Java class for AutoImport complex type</p>.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 *
 * <pre>{@code
 * <complexType name="AutoImport">
 *   <complexContent>
...
@XmlType(name = "AutoImport", propOrder = {
        "berechnungsrichtung",
        "kreditgeschaeft",
