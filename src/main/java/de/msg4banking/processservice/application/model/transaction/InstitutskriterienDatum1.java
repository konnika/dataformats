...
/**
 * InstitutskriterienDatum1
 */
@JsonPropertyOrder({
        InstitutskriterienDatum1.JSON_PROPERTY_NAME,
        InstitutskriterienDatum1.JSON_PROPERTY_WERT,
        InstitutskriterienDatum1.JSON_PROPERTY_AUSGABE,
        InstitutskriterienDatum1.JSON_PROPERTY_INFORMATIV
})
@JsonTypeName("InstitutskriterienDatum_1")
...
public class InstitutskriterienDatum1 {
    ...
    public InstitutskriterienDatum1() {
    }

    public InstitutskriterienDatum1 name(String name) {
    ...
    public InstitutskriterienDatum1 wert(LocalDate wert) {
    ...
    public InstitutskriterienDatum1 ausgabe(Boolean ausgabe) {
    ...
    public InstitutskriterienDatum1 informativ(Boolean informativ) {
    ...
    public boolean equals(Object o) {
        ...
        InstitutskriterienDatum1 institutskriterienDatum1 = (InstitutskriterienDatum1) o;
        return Objects.equals(this.name, institutskriterienDatum1.name) &&
                Objects.equals(this.wert, institutskriterienDatum1.wert) &&
                Objects.equals(this.ausgabe, institutskriterienDatum1.ausgabe) &&
                Objects.equals(this.informativ, institutskriterienDatum1.informativ);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, wert, ausgabe, informativ);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class InstitutskriterienDatum1 {\n");
