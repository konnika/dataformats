...
public enum Usance {
    ...
    USANCE_30_D360("USANCE_30D360"),

    USANCE_ACT360("USANCE_ACT360"),

    USANCE_ACT365("USANCE_ACT365"),
    ...
    @JsonCreator
    public static Usance fromValue(String value) {
        for (Usance b : Usance.values()) {
